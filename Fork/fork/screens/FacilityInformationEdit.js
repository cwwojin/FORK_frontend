...
import { ScrollView, View, Text, TouchableOpacity, StyleSheet, Image, TextInput, Button, SafeAreaView } from 'react-native';
...
import { registerFacility, USERID } from './api';
...
const FacilityInformationEdit = ({ navigation }) => {
  ...
  const [facilityImageUri, setFacilityImageUri] = useState(facilityINFO.profile_img_uri);
